...
function createRuntimeFunction(method, key, _ref) {
  ...
  return registry => (0, _createFunction.default)(registry, {
    meta: {
      documentation: (0, _codec.createType)(registry, 'Vec<Text>', [documentation]),
      modifier: (0, _codec.createType)(registry, 'StorageEntryModifierLatest', 1),
      // required
      type: (0, _codec.createType)(registry, 'StorageEntryTypeLatest', type, 0),
      toJSON: () => key
    },
    method,
    prefix: 'Substrate',
