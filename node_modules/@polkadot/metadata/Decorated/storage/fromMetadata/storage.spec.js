...
describe('storage', () => {
  ...
  const storage = (0, _storage.default)(registry);
  it('should return well known keys', () => {
    expect(typeof storage.substrate).toBe('object'); // @deprecated: The ':auth:' (authorityPrefix) and ':auth:len' (authorityCount) storage keys
