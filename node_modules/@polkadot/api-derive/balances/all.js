...
function calcBalances(api, _ref) {
  ...
  const availableBalance = (0, _types.createType)(api.registry, 'Balance', (0, _util.bnMax)(new _bn.default(0), isVesting && floating.gt(vestedBalance) ? vestedBalance : floating));
  return {
    accountId,
    accountNonce,
    availableBalance,
