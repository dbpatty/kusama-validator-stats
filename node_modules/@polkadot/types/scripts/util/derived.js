...
function getSimilarTypes(registry, type, imports) {
  ...
  if ((0, _class.isChildClass)(_Vec.default, (0, _create.ClassOfUnsafe)(registry, type))) {
    return ["(".concat(getSimilarTypes(registry, (0, _create.getTypeDef)(type).sub.type, imports).join(' | '), ")[]")];
