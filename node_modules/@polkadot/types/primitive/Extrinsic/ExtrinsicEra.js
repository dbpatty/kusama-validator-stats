...
class MortalEra extends _Tuple.default {
  ...
  static decodeMortalEra(registry, value) {
    if ((0, _util.isHex)(value)) {
      return MortalEra.decodeMortalU8a(registry, (0, _util.hexToU8a)(value));
  ...
  static decodeMortalObject(registry, value) {
    const {
      current,
      period
    } = value;
  ...
  static decodeMortalU8a(registry, value) {
    if (value.length === 0) {
      return [new _U.default(registry), new _U.default(registry)];
    }
