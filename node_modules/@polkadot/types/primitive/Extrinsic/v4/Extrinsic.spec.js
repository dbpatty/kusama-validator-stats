...
const decorated = new _metadata.default(registry, _static.default);
...
describe('ExtrinsicV4', () => {
  it('constructs a sane Uint8Array (default)', () => {
    expect(new _Extrinsic.default(registry).toU8a()).toEqual(new Uint8Array([0, 0]));
  });
  it('creates a unsigned extrinsic', () => {
    expect(new _Extrinsic.default(registry, decorated.tx.balances.transfer(keyring.bob.publicKey, 6969)).toHex()).toEqual('0x' + '0600' + // balance.transfer
    'ff' + 'd7568e5f0a7eda67a82691ff379ac4bba4f9c9b859fe779b5d46363b61ad2db9' + 'e56c');
  });
  it('creates a signed extrinsic', () => {
    expect(new _Extrinsic.default(registry, decorated.tx.balances.transfer(keyring.bob.publicKey, 6969)).sign(keyring.alice, {
