...
class Call extends _Struct.default {
  ...
  static decodeCall(registry) {
    ...
    if ((0, _util.isHex)(value) || (0, _util.isU8a)(value)) {
      return Call.decodeCallViaU8a(registry, (0, _util.u8aToU8a)(value), _meta);
  ...
  static decodeCallViaObject(registry, value, _meta) {
  ...
  static decodeCallViaU8a(registry, value, _meta) {
  ...
  static getArgsDef(registry, meta) {
