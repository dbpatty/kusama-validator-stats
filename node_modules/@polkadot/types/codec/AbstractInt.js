...
class AbstractInt extends _bn.default {
  constructor(registry, isNegative) {
    let value = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 0;
    let bitLength = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : DEFAULT_UINT_BITS;
    let isHexJson = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : true;
