...
describe('Compact', () => {
  ...
  describe('encodeU8a', () => {
    ...
    it('encodes max u8 values', () => {
      expect(_Compact.default.encodeU8a(new (_UInt.default.with())(registry, 63))).toEqual(new Uint8Array([0b11111100]));
    });
    ...
    it('encondes a large balance', () => {
      expect(_Compact.default.encodeU8a((0, _create.createType)(registry, 'Balance', '0x5af3107a4000'))).toEqual(new Uint8Array([3 + (6 - 4 << 2), 0x00, 0x40, 0x7a, 0x10, 0xf3, 0x5a]));
    });
  });
  describe('decodeU8a', () => {
    it('decoded u8 value', () => {
  ...
  describe('constructor', () => {
    it('has the correct bitLength for constructor values (BlockNumber)', () => {
      expect(new (_Compact.default.with((0, _create.ClassOf)(registry, 'BlockNumber')))(registry, 0xfffffff9).bitLength()).toEqual(32);
    });
    ...
    it('has the correct encodedLength for constructor values (class BlockNumber)', () => {
      expect(new (_Compact.default.with((0, _create.ClassOf)(registry, 'BlockNumber')))(registry, 0xfffffff9).encodedLength).toEqual(5);
    });
