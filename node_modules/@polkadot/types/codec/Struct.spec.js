...
describe('Struct', () => {
  ...
  it('allows toString with large numbers', () => {
    ...
    expect(new _Struct.default(registry, {
      blockNumber: (0, _create.ClassOf)(registry, 'Option<BlockNumber>')
    }, {
  ...
  it('generates sane toRawType', () => {
    expect(new _Struct.default(registry, {
      ...
      balanceCompact: (0, _create.ClassOf)(registry, 'Compact<Balance>'),
      blockNumber: (0, _create.ClassOf)(registry, 'BlockNumber'),
      compactNumber: (0, _create.ClassOf)(registry, 'Compact<BlockNumber>'),
      optionNumber: (0, _create.ClassOf)(registry, 'Option<BlockNumber>'),
      counter: _U.default,
  ...
  it('generates sane toRawType (via with)', () => {
    const Type = _Struct.default.with({
      accountId: _AccountId.default,
      balance: (0, _create.ClassOf)(registry, 'Balance')
    });
