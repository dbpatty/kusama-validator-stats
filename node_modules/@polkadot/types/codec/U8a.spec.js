...
describe('U8a', () => {
  let u8a;
  beforeEach(() => {
    u8a = new _U8a.default(registry, [1, 2, 3, 4, 5]);
  });
  ...
  it('allows wrapping of a pre-existing instance', () => {
    expect(new _U8a.default(registry, u8a).length).toEqual(5);
  });
