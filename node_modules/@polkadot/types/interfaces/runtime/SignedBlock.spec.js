...
describe('SignedBlock', () => {
  it('decodes a full block', () => {
    const s = (0, _create.createType)(registry, 'SignedBlock', _SignedBlock.default.result);
  ...
  it('decodes to known extrinsics', () => {
    const s = (0, _create.createType)(registry, 'SignedBlock', _SignedBlock2.default.result);
  ...
  describe('eras', () => {
    it('can decode immortals', () => {
      const s = (0, _create.createType)(registry, 'SignedBlock', _SignedBlock004Immortal.default.result);
    ...
    it('can decode mortals', () => {
      const s = (0, _create.createType)(registry, 'SignedBlock', _SignedBlock004Mortal.default.result);
